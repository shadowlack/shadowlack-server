...
MSSPTable = {
    ...
    "CODEBASE": "Custom",
    "CONTACT": "graders@shadowlack.com",  # email for contacting the mud
    "CREATED": "2002",  # year MUD was created
    "ICON": "",  # url to icon 32x32 or larger; <32kb.
    "IP": "",  # current or new IP address
    "LANGUAGE": "English",  # name of language used, e.g. English
    "LOCATION": "Canada",  # full English name of server country
    "MINIMUM AGE": "0",  # set to 0 if not applicable
    "WEBSITE": "https://www.shadowlack.com",
    # Categorisation
    ...
    "STATUS": "Closed Beta",  # Alpha, Closed Beta, Open Beta, Live
